...
return [
    ...
    'process-meraki-webhooks' => ['label' => 'Recepción Meraki', 'description' => 'Normaliza los lotes recibidos desde Meraki usando el límite de cada organización.', 'frequency' => 'Cada minuto', 'command' => 'loratrack:process-meraki-webhooks'],
    ...
    'prune-meraki-history' => ['label' => 'Retención histórica Meraki', 'description' => 'Elimina historial vencido usando el máximo de mantenimiento de cada organización.', 'frequency' => 'Cada hora', 'command' => 'loratrack:prune-meraki-history-incremental', 'arguments' => ['--batch-size' => 100]],
];
