...
|---|---|---|
| Secure development | Pull-request CI, tests, Pint, CodeQL, dependency audit | SDLC policy, reviewer independence, training records |
...
| Vulnerability management | CodeQL, Composer audit, private reporting policy | Remediation SLAs, penetration tests, risk acceptance |
| Incident response | Private disclosure route | Incident plan, contacts, exercises, notification obligations |

Before any customer production approval, obtain the applicable corporate security standard, data-classification rules, architecture review, privacy requirements, vendor-risk questionnaire, penetration-test scope, logging/SIEM requirements, and documented acceptance by the authorized security owner.
